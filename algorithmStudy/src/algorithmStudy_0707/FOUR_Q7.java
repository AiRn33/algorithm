...
//		FOUR_EX4_3 s = new FOUR_EX4_3(64);// 64개를 인큐할 수 있는 큐
		FOUR_EX4_3_2 s2 = new FOUR_EX4_3_2(64);// 64개를 인큐할 수 있는 큐
		
		while(true){
			
			System.out.println("1번 2번 선택");
			int a = sc.nextInt();
...
//					x = sc.nextInt();
//					int num = s.indexOf(x);
//					System.out.println("입력한 데이터 " + x +"는 " + num + "번 쨰에 존재합니다");
//					break;
//				}
			if(a == 2) {
				System.out.println("현재 데이터 수 : " + s2.size() + " / " + s2.capacity());
				System.out.print("(1)푸시 (2)팝 (3)피크 (4)덤프 (5)검색 (0)종료 : ");
